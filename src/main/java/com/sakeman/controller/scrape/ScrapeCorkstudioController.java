...
public class ScrapeCorkstudioController {
    ...
    String LOGIN_FORM_URL = "https://ebookstore.corkagency.com/signin";
    String USERNAME = "ngrqspcial@gmail.com";
    String PASSWORD = "Wakuwaku@@56";

    String mediaName = "コルクスタジオ";
    String flashComment = "コルクスタジオの更新情報が登録されました！";
    List<String> rootUrls = new ArrayList<>() {
        {
            add("https://ebookstore.corkagency.com/series/list");
        }
    };
...
//            System.out.println(freeFlag);
    ...
    public Map<String, String> login() throws IOException{
        ...
        COOKIES.put("login_success_redirect_url", "https://ebookstore.corkagency.com/?logout");
        COOKIES.put("Path", "/");
